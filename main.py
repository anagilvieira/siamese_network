...
def main(hparams):
    ...
    trainer = Trainer.from_argparse_args(args, logger=wandb_logger, max_epochs=200, gpus='2')
    ...
    #siamese_model_dict = dict(type='siamese', arch=create_model(hparams), layer_name='classifier', input_size=(512, 512))
    ...
    output_dir = '/media/avcstorage/Preprocess/GradCam/Results4/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--wb_name', type=str, default="Runs_23_02", help='Project name for WandB')
